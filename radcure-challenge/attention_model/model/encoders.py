...
class Emr_Encoder(nn.Module):
    def __init__(self, feature_size, embedding_size, num_units):
        super().__init__()
        self.embeddings = nn.Parameter(torch.randn(484, embedding_size, requires_grad=True))
        self.lin = nn.Linear(20, 484)
